    ...
    return (
        <div className="flex gap-14.25">
            <div
                ...
                className={`pb-2 flex items-center cursor-pointer ${activeTab === "Repositories" ? "border-b-2 border-[#FD8C73]" : ""}`}
            >
            ...
            <div
                ...
                className={`pb-2 flex items-center cursor-pointer ${activeTab === "Starred" ? "border-b-2 border-[#FD8C73]" : ""}`}>
                <FaRegStar size={24} />
